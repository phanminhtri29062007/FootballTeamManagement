...
public class Player {
    ...
    public boolean setPlayerID(long playerID) {
        if(helperFunctions.findPlayer(playerID) != null) return false;
        this.playerID = playerID;
        return true;
    }
    ...
    public boolean setShirtNumber(int shirtNumber, ArrayList<Player> list) {
        if((shirtNumber<1||shirtNumber>99) || !helperFunctions.checkSNavailability(shirtNumber)) return false;
        this.shirtNumber = shirtNumber;
    return true;}

...
public class PerformanceRecord {
    ...
    public PerformanceRecord(long playerID, int matchID, int goals, int assists,
    ...
    // BR19-21 validation
    public boolean setStats(int goals, int assists, int yellowCards, int redCards, int minutesPlayed) {
